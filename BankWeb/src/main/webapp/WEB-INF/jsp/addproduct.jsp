            ...
            <div class="panel-body">
                <form class="form-horizontal bucket-form" method="get">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="col-sm-3 control-label">产品信息</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3" for="inputSuccess">产品类别</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3" for="inputSuccess">产品标签</label>
                        <div class="col-lg-6">
                            <select class="form-control m-bot15">
                                <option>赚钱</option>
                                <option>投资</option>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">产品推出时间</label>
                        <div class="col-sm-6">
                            <input type="password" class="form-control" placeholder="">
                        </div>
                    </div>
                     <div class="col-sm-6 control-label">
                        <label class="btn btn-success" type="button">确定</label>
                    </div>
                </form>
            </div>
        </section>
